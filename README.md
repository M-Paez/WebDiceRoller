...
2. Plagiarism in any form is not acceptable MP (gave credit to Brad in comments for lion assignment)
...
5. Only source files required to compile and execute an application plus README.md and LICENSE files should be submitted MP
...
8. A LICENSE file should be included and must be MIT, GNU General Public License (GPL), or all rights reserved MP
...
13. Source code must be commented with comments being valuable but conservative
14. When classes are utilized, each class should be in a separate source file
15. File names should be meaningful and consistently follow either a CamelCase or dash-case naming convention
16. Source code quotes should be single straight quotes when possible and user visible quotes should be curly [link]
17. All files should to be UTF-8 compatible text files
18. Git and GitHub should be utilized to manage code
19. Each completed User Story be be associated with a GitHub commit message that identifies the story identifier

This code follows the above guidelines. 
